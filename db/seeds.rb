...
Equipment.create([{ name: 'Beamer1', description: '4:3 Beamer', category: 'Beamer', room: room }, { name: 'WLAN', description: '3 G', category: 'WLAN', room: room }])
...
rooms = Room.create([{ name: 'A-1.3', size: 6}, { name: 'HS3', size: 100}])
