class EventsController < ApplicationController
 ...
 # skip_filter :authenticate_user, :check_vacancy
  ...
  private
    ...
    def event_params
      params.require(:event).permit(:event_id, :name, :description, :participant_count, :starts_at_date, :starts_at_time, :ends_at_date, :ends_at_time, :is_private, :is_important, :show_only_my_events, :message, :commit, :occurence_rule, :schedule, :room_ids => [])
    end
