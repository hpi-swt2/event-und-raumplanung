class RoomPropertiesController < ApplicationController
  ...
  before_action :authenticate_user!,:set_room_property, only: [:show, :edit, :update, :destroy]
  ...
  def create
    ...
    respond_to do |format|
      if @roomProperty.save
        format.html { redirect_to room_properties_url, notice: t('notices.successful_create', :model => RoomProperty.model_name.human) }
